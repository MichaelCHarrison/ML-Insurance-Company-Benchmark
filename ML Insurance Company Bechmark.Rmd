...
for(i in 1:9){
        png(paste("./Attribute Histogram/", "0", toString(i),
                  "plot", colnames(training)[i], ".png", sep = ""),
            width = 480,
            height = 480,
            units = "px")
...
for(i in 10:85){
        png(paste("./Attribute Histogram/", toString(i),
                  "plot", colnames(training)[i], ".png", sep = ""),
            width = 480,
            height = 480,
            units = "px")
...
for(i in 1:9){
        png(paste("./Attribute Density/", "0", toString(i),
                  "plot", colnames(training)[i], ".png", sep = ""),
            width = 480,
            height = 480,
            units = "px")
...
for(i in 10:85){
        png(paste("./Attribute Density/", toString(i),
                  "plot", colnames(training)[i], ".png", sep = ""),
            width = 480,
            height = 480,
            units = "px")
