...
for(i in 1:9){
        png(paste("./Attribute Histogram/", "plot", "0", toString(i),
...
for(i in 10:85){
        png(paste("./Attribute Histogram/", "plot", toString(i),
                  colnames(training)[i], ".png", sep = ""),
            width = 480,
            height = 480,
            units = "px")
...
for(i in 1:9){
        png(paste("./Attribute Density/", "plot", "0", toString(i),
                  colnames(training)[i], ".png", sep = ""),
            width = 480,
            height = 480,
            units = "px")
...
for(i in 10:85){
        png(paste("./Attribute Density/", "plot", toString(i),
                  colnames(training)[i], ".png", sep = ""),
            width = 480,
            height = 480,
            units = "px")
